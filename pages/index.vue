      ...
      <div class="col-md-5 ml-auto">
        <div class="info-area info-horizontal mt-5">
          ...
          <div class="description">
            <h3 class="info-title">Automatico</h3>
            <p class="description">
              Lorem ipsum
            </p>
          </div>
        ...
        <div class="info-area info-horizontal">
          ...
          <div class="description">
            <h3 class="info-title">Basta email</h3>
            <p class="description">
              Lorem ipsum
            </p>
          </div>
        ...
        <div class="info-area info-horizontal">
          ...
          <div class="description">
            <h3 class="info-title">Priorità e task management</h3>
            <p class="description">
              Lorem ipsum
            </p>
          </div>
      ...
      <div class="col-md-7 mr-auto">
        <form @submit.prevent="register">
          <card class="card-register card-white">
            ...
            <base-checkbox class="text-left" validation="required" name="t_and_c">
...
export default {
  ...
  data() {
    return {
      model: {
        email: 'alessandro.macagno@ememory.it',
        fullName: 'Alessandro Macagno',
        password: 'changeme'
      }
    };
  },
